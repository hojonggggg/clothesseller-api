...
@Module({
  imports: [TypeOrmModule.forFeature([WholesalerOrder, WholesalerOrderHistory, WholesalerProduct, WholesalerProductOption, SellerOrder, SellerProduct, SellerProductOption, SellerProductPlus])],
