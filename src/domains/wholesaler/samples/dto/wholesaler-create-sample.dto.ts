...
class WholesalerCreateSampleOptionDto {
...
export class WholesalerCreateSampleDto {
  ...
  @Type(() => WholesalerCreateSampleOptionDto)
  options: WholesalerCreateSampleOptionDto[];
}