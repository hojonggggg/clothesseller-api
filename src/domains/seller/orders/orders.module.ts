...
@Module({
  imports: [TypeOrmModule.forFeature([SellerOrder, SellerProduct, SellerProductOption, WholesalerOrder, WholesalerOrderHistory, WholesalerProduct, WholesalerProductOption])],
